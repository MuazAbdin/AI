...
def play_game(board=None, verbose=True):
    ...
    while True:
        ...
        for idx in range(len(board.players)):
            ...
            print(f'all moves = {len(list(board.all_plays()))} ')
...
if __name__ == '__main__':
    ...
    # import heuristics
    # p = heuristics.heavy_playout(STANDARD)
    # print(p)
    # STANDARD.make_one_play(p, True)
    # for play in STANDARD.all_plays():
    #     print(play, end=' >> ')
    #     print(heuristics.balanced_rack_heuristic(play.rack))
