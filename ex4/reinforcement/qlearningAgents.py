...
class QLearningAgent(ReinforcementAgent):
  ...
  """
    ...
    def __init__(self, **args):
        ...
        "*** YOUR CODE HERE ***"
        # create a data structure that contains the q_values
    ...
    """
        ...
        max_action_score = self.getValue(state)
        actions_options = []
        for action in legal_actions:
            if self.getQValue(state, action) == max_action_score:
                actions_options.append(action)

        return random.choice(actions_options)
